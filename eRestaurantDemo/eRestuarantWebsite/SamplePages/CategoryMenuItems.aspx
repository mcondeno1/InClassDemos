...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <asp:ObjectDataSource ID="CategoryMenuItems" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="MenuCategoyItems_List" TypeName="eRestaurantSystem.BLL.AdminController"></asp:ObjectDataSource>
