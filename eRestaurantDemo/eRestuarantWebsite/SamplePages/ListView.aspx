                ...
                <asp:ListView ID="ReservationList" runat="server" DataSourceID="ODSReservations">
                    <AlternatingItemTemplate>
                        <tr style="background-color:#FFF8DC;">
                            ...
                            <td>
                                <asp:Label ID="ReservationDateLabel" runat="server" Text='<%# Eval("ReservationDate","{0:MM dd,yyyy h:mm tt}") %>' />
                            </td>
                            <td>
                                <asp:Label ID="NumberInPartyLabel" runat="server" align="right" Text='<%# Eval("NumberInParty") %>' />
                            </td>
                            <td>
